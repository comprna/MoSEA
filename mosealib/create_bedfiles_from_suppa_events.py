...
def main():
	...
	try:
		...
		print 'create_bedfiles_from_suppa_events.py --ifile <input file> --event <event-type> --ext <length-extension> --ofile <output file>'
		sys.exit(2)
	...
	if len(opts) == 4:
		...
		print '\nUSAGE:python create_bedfiles_from_suppa_events.py --ifile <input file> --event <event-type> --ext <length-extension> --ofile <output file>\n'
		sys.exit(2)
